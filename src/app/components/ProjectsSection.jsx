...
export default function ProjectsSection() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Real-time social media analytics dashboard with beautiful charts and insights. Built with Next.js and integrated with multiple APIs.',
      image: '📊',
    ...
    },
    {
      ...
      description: 'Modern chat application with AI integration using OpenAI API. Features real-time messaging, file sharing, and smart responses.',
      image: '🤖',
