...
const Contact = () => {
  ...
  const [refAnima, inView] = useInView({
    threshold: 0.2,
    // triggerOnce: true,
  });
  ...
  const validateForm = () => {
    ...
    if (formData) {
      if (!formData.user_name.value) formErrors.user_name = "Name is required.";
      ...
      if (!formData.message.value) formErrors.message = "Message is required.";
    }
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 " ref={refAnima}>
        ...
        <motion.div ref={titleRef} style={{ y }}>
          ...
          >
            ...
            <p className="text-lg text-blue-100 max-w-3xl mx-auto">
              ...
              quickly—I can deliver. I build fast, customized, and responsive
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 px-6">
        ...
        <div className="hidden lg:flex flex-col mb-auto w-[30%]">
          ...
          >
            Have a project, freelance opportunity, or just want to say hi? Drop
            a message and I will respond back within 24 hours.
          </motion.p>
          {/* Right: Image */}
          <motion.div
