        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-300 mb-6 leading-relaxed">
              ...
              functional web experiences. I love turning complex problems into 
              simple, elegant solutions that users actually enjoy using.
            </p>
          ...
          >
            <h3 className="text-2xl font-bold mb-8 text-white">Skills & Technologies</h3>
